...
// ReturnCertRep creates a new PKIMessage with CertRep data, signing it with the Cert Authority credentials.
func (msg *PKIMessage) ReturnCertRep(crtAuth *x509.Certificate, keyAuth *rsa.PrivateKey, crt *x509.Certificate) (*PKIMessage, error) {
